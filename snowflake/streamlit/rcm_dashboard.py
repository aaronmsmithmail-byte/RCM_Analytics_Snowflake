...
from src.cortex_chat import render_chat_ui
...
from src.validators import run_all_validators as validate_all
...
# On the first run, it calls load_all_data() (which queries Snowflake).
...
@st.cache_data
def get_data():
    """Load all RCM data from Snowflake (cached after first call)."""
...
# Metric card styling is handled by custom CSS above
...
# =====================================================================
# TAB 12: AI ASSISTANT (Cortex Analyst)
# =====================================================================
# Chat interface powered by Snowflake Cortex Analyst. Uses the semantic
# model YAML staged at @RCM_ANALYTICS.STAGING.RCM_STAGE/cortex/ to
# generate and execute SQL queries against the Silver layer.
# =====================================================================
with tab12:
    render_chat_ui()
